...
def mr_x():
    time.sleep(1)
    os.system("clear")
    print (" Subrek YT Qiin Creator Slurr, Gk Subrek Gk Kawan")
    time.sleep(1)
    os.system("xdg-open https://youtube.com/channel/UCrS6IXc7I4Hp1IlCNGDKwmA")
    time.sleep(5)
    os.system("clear")
...
def banner_anjay_subs_mr_dark():
    ...
    print ("")
    print ("    > Author  : Ay ")
    print ("    > YouTube : Qiin Creator ")
    print ("    > Github  : github.com/Ainul130496 ")
    print ("")
